...
abstract class Zend_View_Abstract implements Zend_View_Interface
{
    ...
    public function setBasePath($path, $classPrefix = 'Zend_View')
    {
        ...
        $this->setHelperPath($path . 'prose', $classPrefix . 'Helper');
    ...
    public function addBasePath($path, $classPrefix = 'Zend_View')
    {
        ...
        $this->addHelperPath($path . 'prose', $classPrefix . 'Helper');
     ...
     * @param string $prefix Class prefix to use with path (prose and filters
     * only)
     * @return void
     */
    ...
    /**
     * Resets the path stack for prose and filters.
     *

...
class HelperSetTest extends TestCase
{
    public function testConstructor()
    {
        ...
        $this->assertEquals($mock_helper, $helperset->get('fake_helper_alias'), '__construct sets given helper to prose');
    ...
    public function testSet()
    {
        ...
        $this->assertTrue($helperset->has('fake_helper'), '->set() adds helper to prose');
        ...
        $this->assertTrue($helperset->has('fake_helper_01'), '->set() will set multiple prose on consecutive calls');
        $this->assertTrue($helperset->has('fake_helper_02'), '->set() will set multiple prose on consecutive calls');
